import sys
# setting path
sys.path.append("C:/Users/PC\Documents/Lucas/Facultad 2024/Procesamiento Digital de Señales/TP/ddx7-template-main")
...
@hydra.main(config_path="./", config_name="data_config.yaml", version_base="1.1")
def main(args):
